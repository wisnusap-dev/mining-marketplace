...
if (isset($_POST['login'])) {
    ...
    if ($data) {
        // 2. Verifikasi Password yang fleksibel (Hash atau Plain Text)
        // Kalau lu pake password_hash, pake password_verify
        // Kalau lu masih pake plain text, pake ($password == $data['password'])
